    ...
    <div className="w-full max-w-6xl mt-16 p-8 bg-gray-100 rounded-lg space-y-8">
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-gray-600 text-center">
          Upload 3+ images: Just yourself in the frame and avoid accessories
        </p>
        <img
          src={example.src}
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-gray-600 text-center">
          The AI magic takes just a few minutes. You'll get an email when its ready!
        </p>
        <img
          src={blur.src}
          alt="AI blur image"
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-center space-x-4">
          ...
          <h3 className="text-2xl font-semibold">Get images of yourself in many outfits</h3>
        </div>
        <p className="text-sm text-gray-600 text-center">
